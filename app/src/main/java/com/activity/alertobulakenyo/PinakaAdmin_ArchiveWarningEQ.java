...
public class PinakaAdmin_ArchiveWarningEQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinaka_admin_archive_warning_eq);
    ...
    {
        super.onBackPressed();
        Intent intent = new Intent(PinakaAdmin_ArchiveWarningEQ.this, PinakaAdmin_RepArchiveWarning.class);
