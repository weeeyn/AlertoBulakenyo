...
public class Admin_HotMarilao extends AppCompatActivity {

    Button btnAddHotline;
    private RecyclerView rvHotMar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_hot_marilao);

        btnAddHotline = (Button) findViewById (R.id.btnAddHotline);

        rvHotMar = (RecyclerView) findViewById (R.id.rvHotMar);

        hotlinesHolderArrayList = new ArrayList<>();
        rvHotMar.setHasFixedSize(true);
        rvHotMar.setLayoutManager(new LinearLayoutManager(this));
        admin_hotlinesRVAdapter = new Admin_HotlinesRVAdapter(hotlinesHolderArrayList, this);
        rvHotMar.setAdapter(admin_hotlinesRVAdapter);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(Admin_HotMarilao.this, "No Hotlines Posted", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        ...
        btnAddHotline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Admin_HotMarilao.this, Admin_AddHotline.class);
