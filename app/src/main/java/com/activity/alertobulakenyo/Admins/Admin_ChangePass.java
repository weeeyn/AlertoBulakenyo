...
import com.activity.alertobulakenyo.ResidentUsers.ChangePass;
import com.activity.alertobulakenyo.ResidentUsers.Home;
import com.activity.alertobulakenyo.ResidentUsers.Profile;
        ...
        btnValidatePass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userPwdCurr)) {
                    Toast.makeText(Admin_ChangePass.this, "Please enter your current password to authenticate.", Toast.LENGTH_SHORT).show();
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Admin_ChangePass.this, "Password has been verified." + "You can change password now.", Toast.LENGTH_SHORT).show();
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(Admin_ChangePass.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                    progressBar.setVisibility(View.GONE);
                                }
        ...
        if (TextUtils.isEmpty(userPwdNew)) {
            ...
            user.updatePassword(userPwdNew)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()) {
                                Toast.makeText(Admin_ChangePass.this, "Password changed successfully!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(Admin_ChangePass.this, Admin_Profile.class);
                                startActivity(intent);
                                finish();
                            } else {
                                try {
