...
public class Admin_EvacStaMaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_evac_sta_maria);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(Admin_EvacStaMaria.this, "No Evacuation Centers Listed.", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
