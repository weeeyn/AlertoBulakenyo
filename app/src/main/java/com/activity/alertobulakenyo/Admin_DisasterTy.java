    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardWarn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Admin_DisasterTy.this, Admin_DisasterTyInfo.class);
        ...
        btnPick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePicker = new DatePickerDialog(Admin_DisasterTy.this, R.style.DatePickerTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
