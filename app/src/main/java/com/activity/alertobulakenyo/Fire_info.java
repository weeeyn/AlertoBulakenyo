...
public class Fire_info extends AppCompatActivity {
    ...
    TextView tvDate, tvTime, tvFireAlert, tvLoc, tvIns;
    Button btnEvac;
//    private FirebaseFirestore fStore = FirebaseFirestore.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WarningHolder warningHolder = (WarningHolder) getIntent().getSerializableExtra("fireinfo");
        ...
        tvFireAlert.setText(warningHolder.getFireLevel());
        ...
        btnEvac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Fire_info.this, Evacuation.class);
