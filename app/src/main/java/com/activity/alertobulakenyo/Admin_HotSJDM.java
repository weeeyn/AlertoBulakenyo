...
public class Admin_HotSJDM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_hot_sjdm);
        ...
        rvHotSJDM.setAdapter(admin_hotlinesRVAdapter);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(Admin_HotSJDM.this, "No Hotlines Posted", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        ...
        btnAddHotline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Admin_HotSJDM.this, Admin_AddHotline.class);
