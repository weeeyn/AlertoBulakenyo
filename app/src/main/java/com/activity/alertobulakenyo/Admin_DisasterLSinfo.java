...
public class Admin_DisasterLSinfo extends AppCompatActivity {
...
//    private FirebaseFirestore fStore = FirebaseFirestore.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_disaster_lsinfo);

        WarningHolder warningHolder = (WarningHolder) getIntent().getSerializableExtra("lswarn");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Admin_DisasterLSinfo.this);
...
//                                        Intent intent = new Intent(getApplicationContext(), Admin_DisasterLS.class);
