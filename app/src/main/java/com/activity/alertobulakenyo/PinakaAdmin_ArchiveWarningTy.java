...
public class PinakaAdmin_ArchiveWarningTy extends AppCompatActivity {

    TextView tvDate, tvTime, tvTyName, tvSignal, tvLoc, tvIns, tvHot01, tvHot02, tvHot03, tvHot04, tvHot05,tvHot06, tvHot07, tvHot08, tvHot09, tvHot10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinaka_admin_archive_warning_ty);
    ...
    {
        super.onBackPressed();
        Intent intent = new Intent(PinakaAdmin_ArchiveWarningTy.this, PinakaAdmin_RepArchiveWarning.class);
