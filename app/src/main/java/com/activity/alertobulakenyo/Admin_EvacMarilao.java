...
public class Admin_EvacMarilao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_evac_marilao);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(Admin_EvacMarilao.this, "No Evacuation Centers Listed.", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
