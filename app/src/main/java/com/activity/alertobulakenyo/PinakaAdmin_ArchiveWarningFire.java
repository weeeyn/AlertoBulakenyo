...
public class PinakaAdmin_ArchiveWarningFire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinaka_admin_archive_warning_fire);
    ...
    {
        super.onBackPressed();
        Intent intent = new Intent(PinakaAdmin_ArchiveWarningFire.this, PinakaAdmin_RepArchiveWarning.class);
