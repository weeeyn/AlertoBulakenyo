...
import com.activity.alertobulakenyo.Adapters.AdapterFlood;
...
public class Flood extends AppCompatActivity {
    ...
    private AdapterFlood adapterFlood;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterFlood = new AdapterFlood(warningHolderArrayList, this);
        rvDisFlood.setAdapter(adapterFlood);
