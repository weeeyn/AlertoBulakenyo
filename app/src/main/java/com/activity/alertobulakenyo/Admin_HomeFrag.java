 ...
 * Use the {@link Admin_HomeFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Admin_HomeFrag extends Fragment {
     ...
     * @return A new instance of fragment Admin_HomeFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static Admin_HomeFrag newInstance(String param1, String param2) {
        Admin_HomeFrag fragment = new Admin_HomeFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgDisaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), Admin_Disaster.class);
